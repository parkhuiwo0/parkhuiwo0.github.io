...
더 충격적인 부분은 눈문에서 Closed-Book 성능과의 벤치마크 결과 GPT-3.5-Turbo의 경우에는 56.1%의 성능을 보였지만, 문서를 20~30개 주고 정답을 가운데에 배치하였더니 성능이 56.1%보다 떨어졌다는 점입니다.
...
앞선 실험에서 모델이 Context의 가운데에 있는 정보를 검색하고 사용하는 데에 있어서 성능이 저하된다는 결과가 놩ㅆ습니다.
그렇다면, 모델은 단순히 정보를 
