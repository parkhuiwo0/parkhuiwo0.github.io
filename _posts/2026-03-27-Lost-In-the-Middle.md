...
Contriever로 AI가 답변을 방해하는 문서를 추출한 것도 흥미로운 포인트였습니다. [하드 네거티브(Hard negatives)](https://wikidocs.net/184729)가 되는 정답 문서와 매우 흡사한 가짜 문서들을 선별했다는 부분에서 정확한 정보 추출 능력이 있는지 검증이 제대로 되겠다는 생각이 들었어요.
